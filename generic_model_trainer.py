# Use this file to run RNN for test phase
# It will first tune the hyperparameters to train the RNN and then will connect to other scripts which will do forecasting, re-scaling and error calculating
import numpy as np
