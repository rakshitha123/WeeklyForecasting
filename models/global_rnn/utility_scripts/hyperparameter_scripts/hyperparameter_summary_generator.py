...
input_path = 'WeeklyForecasting/results/optimized_configurations/'

output_path = 'WeeklyForecasting/results/optimized_configurations/aggregate_hyperparameter_configs/'
